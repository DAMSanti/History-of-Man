...
# --- LA MALLA DEL TERRENO: construirla, trocearla y cachearla -------------
#
# Estas catorce funciones estaban en diez sitios del fichero. Juntarlas NO
# cambia nada -este commit solo mueve lineas- pero deja el corte siguiente en
# una sola pieza. Ver ARQUITECTURA §3, regla 2.
#
# Es todo lo que va de un campo de alturas a una malla dibujable: los arrays de
# vertices y normales, los niveles de detalle, el troceado en cuadrantes, la
# colision y la cache en disco que se salta todo lo anterior.
